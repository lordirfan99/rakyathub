...
| Aspek | Medical Card | Critical Illness Insurance |
|-------|-------------|---------------------------|
| **Apa dilindungi?** | Bil rawatan hospital (wad, surgeri, ubat) | Satu lump sum bila disahkan sakit kritikal |
| **Macam mana bayaran?** | Cashless — bayar terus ke hospital | Tunai — bank in ke akaun korang |
| **Bila guna?** | Masa masuk hospital | Masa disahkan sakit kritikal (walaupun tak masuk hospital) |
| **Coverage utama** | Kos perubatan | Pendapatan hilang & kos sampingan |
| **Premium (anggaran)** | RM80 – RM400+/bulan (ikut umur & limit) | RM30 – RM150+/bulan (ikut umur & sum assured) |
| **Sesuai untuk** | Semua orang — nak rawatan hospital tanpa stress bayar | Yang ada tanggungan (rumah, anak, keluarga) |
...
| Penyakit | Kos Anggaran (Hospital Swasta) |
|----------|-------------------------------|
...
| ICU setiap hari | RM2,000 – RM5,000 sehari |

*Sumber: [InsuranceInfo](https://insuranceinfo.my/), [RinggitPlus Medical Card Comparison](https://ringgitplus.com/en/health-insurance/medical-card/)*
...
| Plan | Harga Sebulan (Anggaran) | Apa Dapat? |
|------|------------------------|-----------|
| **Base MHIT Standard (BNM)** | RM50 – RM120 | Coverage hospital asas RM100K/tahun, co-payment |
| **Medical Card Biasa (e.g. AIA, Prudential, Great Eastern)** | RM120 – RM350 | Coverage RM500K – RM1Juta/tahun, panel hospital luas |
| **Critical Illness Standalone (FWD, Generali)** | RM40 – RM100 | Lump sum RM50K – RM100K bila sakit kritikal |
| **Medical Card + CI Rider (Combo)** | RM150 – RM450 | Medical card + CI lump sum dalam satu plan |
| **Takaful Critical Illness (Prudential BSN Takaful, Etiqa)** | RM50 – RM120 | Caruman lump sum ikut prinsip Syariah |

*Sumber: [RinggitPlus](https://ringgitplus.com/en/health-insurance/medical-card/), [FWD Malaysia](https://www.fwd.com.my/critical-illness-insurance-takaful/), [CodeBlue — Base MHIT Analysis](https://codeblue.galencentre.org/2026/01/my-medical-plan-is-better-value-than-governments-base-mhit/)*
...
Tapi dalam tempoh 6 bulan rawatan:
✔️ Korang **tak boleh kerja** — hilang pendapatan 6 bulan × RM3,500 = **RM21,000**
✔️ Rawatan tambahan (ubat target, fisioterapi) = **RM15,000 – RM30,000**
✔️ Pengangkutan ulang-alik hospital = **RM2,000 – RM3,000**
✔️ Makanan istimewa / supplemen = **RM1,500 – RM3,000**
...
Premium medical card dan critical illness layak untuk **[pelepasan cukai](/panduan-e-filing-cukai-pendapatan-2026/)** bawah seksyen 46(1)(b) maksimum RM3,000 setahun. Jangan lepaskan!

### 4. Bandingkan Plan Online
Guna platform macam [RinggitPlus](https://ringgitplus.com/en/health-insurance/medical-card/) atau [Qoala](https://www.qoala.my/) untuk bandingkan harga dan coverage dari pelbagai insurer sebelum beli.

### 5. Guna DocuKilat Untuk Urusan Dokumen
Nak buat tuntutan insurans atau sediakan dokumen perlindungan? Guna **[DocuKilat — Penjana Dokumen AI](https://docukilat.rakyathub.my/)** untuk hasilkan surat tuntutan, surat kuasa, atau dokumen insurans lain dalam masa 1 minit. Jimat masa, tak perlu pening kepala!

---

## 🔗 Sumber & Rujukan

- [Bank Negara Malaysia — Base MHIT Plan](https://www.bnm.gov.my/-/base-mhit-plan) — Pelan insurans perubatan asas kerajaan
- [RinggitPlus — Medical Card Comparison](https://ringgitplus.com/en/health-insurance/medical-card/) — Bandingkan harga & plan medical card Malaysia 2026
- [FWD Malaysia Critical Illness](https://www.fwd.com.my/critical-illness-insurance-takaful/) — Contoh pelan critical illness online
- [CodeBlue — Base MHIT vs Plan Lain](https://codeblue.galencentre.org/2026/01/five-cheaper-better-value-medical-plans-than-governments-base-mhit/) — Analisis perbandingan pelan murah

### Internal Links
- [📖 Panduan Medical Card Malaysia 2026 — First Time Buyer](/panduan-medical-card-malaysia-2026-first-time-buyer/)
- [🛡️ Takaful vs Insurans Biasa: Panduan Perlindungan Anak Muda](/takaful-vs-insurans-biasa-panduan-perlindungan/)
- [📈 Premium Insurans Perubatan Naik 2026? Alternatif & cara jimat](/premium-insurans-perubatan-naik-2026-alternatif-mhit/)
- [💰 Tabung Kecemasan Malaysia — Berapa Patut Simpan & Cara Mula](/tabung-kecemasan-malaysia-berapa-patut-simpan-cara-mula/)
- [📊 Kalkulator DSR](/kalkulator/dsr/) — Semak nisbah komitmen vs pendapatan
- [📋 Kalkulator Pelaburan](/kalkulator/pelaburan/) — Unjurkan pulangan pelaburan jangka panjang
...
Mungkin sukar. Kebanyakan plan akan exclude pre-existing condition atau kenakan **loading** (premium lebih tinggi). Tapi ada pelan khas untuk individu dengan pre-existing condition — cuma limited. Mulai 2026, BNM sedang gubal dasar baru untuk [pastikan syarikat insurans tidak boleh tolak claim sesuka hati](https://www.nst.com.my/news/nation/2026/03/1406358/insurance-companies-can-no-longer-reject-patient-claims).
