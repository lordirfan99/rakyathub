...
author: RakyatHub
faq:
  - question: "Macam mana nak tahu website tu scam atau tidak?"
    answer: "Check 10 perkara: HTTPS & SSL, domain age (guna whois), Semak Mule CCID, ulasan pelanggan luar, contact info lengkap, dasar privasi, harga munasabah, cara bayaran selamat, website checker tools (ScamAdviser), dan percaya pada gerak hati. Kalau ragu-ragu, jangan beli."
  - question: "Apa itu Semak Mule CCID dan macam mana nak guna?"
    answer: "Semak Mule adalah portal PDRM di semakmule.rmp.gov.my yang membolehkan anda semak sama ada nombor akaun bank, nombor telefon, atau nama syarikat pernah dilaporkan dalam kes jenayah komersil. Hanya masukkan nombor akaun dan sistem akan tunjuk statusnya."
  - question: "Kalau dah terlanjur beli dekat website scam, apa perlu buat?"
    answer: "Segera hubungi NSRC di talian 997 (24 jam) — panggilan ini kini dianggap laporan polis. Kemudian blok kad bank/kad kredit, buat laporan polis di balai berhampiran, dan kumpul semua bukti (screenshot, resit transaksi, email)."
  - question: "Website ada HTTPS dan padlock, confirm selamat ke?"
    answer: "Tidak semestinya. Scammer sekarang pun boleh dapat SSL percuma dari Let's Encrypt. HTTPS cuma confirm data anda dienkripsi semasa hantar — bukan confirm penjual tu sah atau jujur. Kena check lebih dari sekadar padlock."
  - question: "Apa website checker tools yang boleh guna percuma?"
    answer: "Antara yang percuma: ScamAdviser.com, WebSafeChecker.com, URLVoid.com, dan Google Safe Browsing. Tools ni scan domain, check reputasi, dan bagi trust score. Tapi jangan percaya 100% — guna sebagai rujukan tambahan."
---
...
1. **Scam e-dagang** (beli-belah online) — paling tinggi jumlah kes
2. **Scam tawaran pekerjaan palsu** — 1,537 kes, rugi RM31.8 juta (Jan-Mac 2026 je)
3. **Scam pelaburan tidak wujud** — rugi paling besar secara purata
...
> 💡 **Tip:** Kalau terasa dah kena scam, jangan tunggu. Terus hubungi **[NSRC 997](https://nsrc.gov.my)** — hotline 24 jam yang beroperasi setiap hari termasuk cuti umum. Panggilan 997 kini diterima sebagai laporan polis rasmi.
...
- [who.is](https://who.is) — masukkan URL, tengok tarikh pendaftaran domain
- [ICANN Lookup](https://lookup.icann.org) — alternatif rasmi
...
**Contoh:** Website reputable macam **[Shopee Malaysia](https://shopee.com.my)** dah beroperasi sejak 2015. Kalau website e-commerce yang dakwa "premium brand" tapi domain register bulan lepas — **red flag besar**.
...
**Cara guna:**
1. Buka [semakmule.rmp.gov.my](https://semakmule.rmp.gov.my)
2. Masukkan **nombor akaun bank** penjual
3. Sistem akan tunjuk samada akaun tu pernah terlibat dalam kes jenayah komersil
4. Boleh juga check **nombor telefon** dan **nama syarikat**
...
- Cari dekat **platform bebas** — guna Google search: `[nama website] scam`, `[nama website] review`, `[nama website] penipuan`
- Check **Facebook page** penjual — tengok komen dekat posting (bukan rating je)
...
- Email guna domain sendiri (bukan `[email]@gmail.com` atau `[email]@yahoo.com`)
...
- Guna **[Kalkulator Emas](/kalkulator/emas/)** atau **[Kalkulator Kereta](/kalkulator/kereta/)** untuk banding harga sebenar produk yang standard rate
...
| Tool | Fungsi | Rating |
|------|--------|:------:|
| [ScamAdviser.com](https://scamadviser.com) | Trust score, review pengguna, domain check | ⭐⭐⭐⭐⭐ |
| [WebSafeChecker.com](https://websafechecker.com) | SSL, WHOIS, trust score | ⭐⭐⭐⭐ |
| [URLVoid.com](https://urlviod.com) | 30+ engine scan reputasi domain | ⭐⭐⭐⭐⭐ |
| [Google Safe Browsing](https://transparencyreport.google.com/safe-browsing/search) | Check sama ada website ada malware/phishing | ⭐⭐⭐⭐⭐ |

**Cara guna:**
1. Copy URL website yang nak check
2. Paste dekat salah satu tool atas
3. Dalam 5-10 saat, dapat laporan penuh
4. Kalau trust score < 60%, **jangan beli**
...
- Report ke [CyberSecurity Malaysia](https://www.cybersecurity.my)
...
1. ✅ **Bookmark Semak Mule** — [semakmule.rmp.gov.my](https://semakmule.rmp.gov.my) — check sebelum bayar
2. ✅ **Simpan nombor NSRC 997** dalam phone — guna kalau emergency
3. ✅ **Kongsi artikel ni** dengan family & kawan — awareness adalah pertahanan terbaik

📌 *Jangan lupa bookmark **[rakyathub.my](https://rakyathub.my)** untuk lebih banyak tips kewangan, keselamatan dan teknologi digital!*
...
Semak Mule adalah portal PDRM di [semakmule.rmp.gov.my](https://semakmule.rmp.gov.my) yang membolehkan anda semak sama ada nombor akaun bank, nombor telefon, atau nama syarikat pernah dilaporkan dalam kes jenayah komersil. Hanya masukkan nombor akaun dan sistem akan tunjuk statusnya.
...
Antara yang percuma: [ScamAdviser.com](https://scamadviser.com), [WebSafeChecker.com](https://websafechecker.com), [URLVoid.com](https://urlviod.com), dan [Google Safe Browsing](https://transparencyreport.google.com/safe-browsing/search). Tools ni scan domain, check reputasi, dan bagi trust score. Tapi jangan percaya 100% — guna sebagai rujukan tambahan.
