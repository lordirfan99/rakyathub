  ...
  links: [
    {
      ...
      links: [
        ...
        { text: 'Diskaun', href: '/kalkulator/diskaun/' },
        { text: 'Tip/Bahagi Bil', href: '/kalkulator/bahagi-bil/' },
        { text: 'Penukar Wang', href: '/kalkulator/currency-converter/' },
        { text: 'Cukai Jalan', href: '/kalkulator/cukai-jalan/' },
        { text: 'Kos Minyak', href: '/kalkulator/kos-minyak/' },
        { text: 'Umur', href: '/kalkulator/umur/' },
        { text: 'Beza Tarikh', href: '/kalkulator/beza-tarikh/' },
